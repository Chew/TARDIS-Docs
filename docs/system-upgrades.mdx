...
```yaml title="/plugins/TARDIS/system_upgrades.yml"
branch: 100
# architecture branch
architecture:
...
tools:
    ...
    stattenheim_remote: 4000 # Cost for using the Stattenheim Remote and \`/tardis come_here\` command - requires the _Telepathic Circuit_ upgrade.
navigation:
