...
<ConfigTable data={`
block: PRISMARINE_BRICKS # The type of block that TARDIS items will be displayed on. This should be specified using the [Bukkit Material ENUM](https://jd.papermc.io/paper/26.2/org/bukkit/Material.html) name
