...
[Version 6](https://github.com/eccentricdevotion/TARDIS/releases/tag/1.21.11) of the TARDIS plugin contains some major rewrites of the plugin's code to update it to reflect the way Minecraft has changed custom item models.
