...
<TabbedImage name={"Control Menu Companions button"} description={""} folder={"docs"} image={"control-companions.jpg"} />
...
<TabbedImage name={"Companions GUI"} description={""} folder={"docs"} image={"control-gui.jpg"} />
