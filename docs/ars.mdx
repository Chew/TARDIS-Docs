...
are compatible, however you may need to make a new TARDIS to take advantage of the
system if your current TARDIS was created before version 2.6 of the plugin.
...
To use ARS you need the permission `tardis.architectural`.

You will also need the permission for the room you want to grow - you can see a list of permissions here: [Room permissions](/room-perms)
...
<TabbedImage name={"ARS GUI"} description={"Architectural Reconfiguration System GUI breakdown."} folder={"docs"} image={"arsgui.jpg"} />
...
10. The purple wool block takes you to the [Room Relocator](room-relocator) GUI where you can move rooms.
