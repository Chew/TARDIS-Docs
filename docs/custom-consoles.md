...
- `seed: [Material]` — this will determine the type of seed block this TARDIS uses — `[Material]` must be a valid Bukkit [Material](https://jd.papermc.io/paper/26.1.2/org/bukkit/Material.html) enum
