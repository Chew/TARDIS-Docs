...
You can transfer energy either from your TARDIS, or using your own Time Lord energy. To do this you hold an Artron Storage Cell in your hand and use the `/tardisartron` command. For more information see [Artron Storage Cells](/artron-cells). You can also combine non-full Artron energy in Artron Storage Cells with this command.
...
`tardisartron:
    ...
    usage: /\<command\> [tardis|timelord|combine] [amount]
`} />

:::tip[Combining Artron Storage Cells]

To top up one Artron Storage Cell to the maximum level with the energy from another Artron Storage Cell, hold one cell in your main hand, and one cell in your offhand and then run the command:
...
This command will let you create either sideways gravity wells, or up and down ones of any height (though you’ll need to build your own gravity shaft). For more information see [Gravity Wells](/rooms/gravity-wells).
