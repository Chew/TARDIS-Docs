...
args={
    ...
    dialogs:
      description: Toggle whether dialogs are shown (where available) instead of chest GUIs.
    ...
    info:
      description: Sets whether the to show the TARDIS Information System chest GUI or the chat based GUI. May be affected by the dialogs preference.
