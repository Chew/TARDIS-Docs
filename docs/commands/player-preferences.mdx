...
Sonic Screwdriver, sneaking and right-clicking air or using the _Prefs_ button in the [Control Menu GUI](/control-menu) will open the [Player Preferences](/player-prefs-menu)UI. Use the _General Preferences Menu_ button to access all options.
