...
args={
    ...
    name_key:
      ...
      permission: tardis.timetravel
      usage: Hold the key in your hand, then type /<command> name_key [new name]
    occupy:
    ...
    remove_save:
      ...
      usage: /<command> remove_save [name]
    rename_save:
      description: Rename a saved destination.
      permission: tardis.save
      usage: /<command> rename_save [old name] [new name]
    reorder_save:
      description: Reorder a saved destination in the TARDIS Saves GUI.
      permission: tardis.save
      usage: /<command> reorder_save [name] [slot number]
    rescue:
    ...
    save_icon:
      ...
      permission: tardis.save
      usage: /<command> save_icon [save] [material]
    secondary:
