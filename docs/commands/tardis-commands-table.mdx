...
args={
    ...
    update:
      ...
      permission: tardis.update
      usage:  | 
        /<command> update [ advanced | allay | ars | artron | back | backdoor | bamboo | beacon | bell | birdcage | button | chameleon | condenser | control | creeper | direction | dispenser | door | eps | farm | flight | forcefield | frame | fuel | generator | handbrake | hinge | hutch | igloo | iistubil | info | keyboard | lava| light | map | monitor | monitor-frame | pen | rail | rotor | save-sign | scanner | siege | smelt | stable | stall | storage | telepathic | temporal |  terminal | throttle | toggle-wool | vault | village | weather | world-repeater | x-repeater | y-repeater | z-repeater | zero ]
    version:
