...
You can also optionally set an exterior preset that the TARDIS automatically switches to by adding the arguments `/tardis sethome preset [PRESET]` - use tab completion to select your desired exterior.
