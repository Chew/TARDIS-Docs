...
preferences:
    ...
    key: GOLD_NUGGET # Sets the TARDIS key item. You can use any valid Bukkit Material ENUM. A list can be found here: [https://jd.papermc.io/paper/1.21.11/org/bukkit/Material.html](https://jd.papermc.io/paper/1.21.11/org/bukkit/Material.html)
