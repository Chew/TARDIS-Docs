...
Artron Capacitors are used to increase the amount of energy a TARDIS can store. Capacitors are stored in the Artron Capacitor Storage block found in the [Eye of Harmony](/rooms/eye) room. Every TARDIS comes with one Artron Capacitor installed when first grown.
