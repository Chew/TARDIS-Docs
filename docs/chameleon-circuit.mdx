...
keywords: [chameleon, chameleon circuit]
---
...
<TabbedImage name={"Control Menu Chameleon button"} description={""} folder={"chameleon"} image={"control_menu.jpg"} heading={false} />

## Using the circuit

To use the Chameleon Circuit, right-click on the Control Menu sign, then click the Chameleon Circuit button.

<TabbedImage name={"Chameleon Circuit GUI"} description={""} folder={"chameleon"} image={"new_circuit.jpg"} heading={false} />
