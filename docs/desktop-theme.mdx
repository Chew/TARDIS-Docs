...
:::info Upgrade cost calculation

Desktop upgrades costs are calculated by the plugin when the server starts up. For more information see the [Desktop console upgrade costs](/desktop-costs) page.
