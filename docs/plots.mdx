...
You can also change the plot size, how many plots a player can claim, and whether the plugin should automatically create a TARDIS area when the world is first generated.

```yaml title="/plugins/TARDIS/generator.yml"
# Use Paper Material names
...
- To give the plot a nice name, run the command `/tardisplot name [the new name]` - the name must be between 2 and 16 characters. You will be prompted to right-click the wall block **under** the sign again.
