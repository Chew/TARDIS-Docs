...
* The upper chest is the **fuel** chest &mdash; add any items that can be burnt, such as coal, logs etc.
* The lower chest is the **ore** chest &mdash; add the items that you want to smelt in here.
