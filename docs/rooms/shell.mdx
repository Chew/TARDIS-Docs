...
To save the chameleon construct, click the stone button on the platform. The Shell GUI opens.

![shell room showing button](/images/docs/shell.jpg)

<TabbedImage name={"Shell GUI"} description={""} folder={"docs"} image={"shell_gui.jpg"} heading={false} />

- Use the block buttons at the top to select previously saved shells
- To set the Chameleon circuit to the selected shell, click the **Use** button
- To remove the selected shell, click the **Delete** button
- To update an exisiting shell, select the appropriate shell button, then click the **Update** button
- To save a new shell, click the **Save** button
- To clear the shell building platform, click the **New** button
...
<TabbedImage name={"Shell Loader"} description={""} folder={"docs"} image={"shell_loader.jpg"} heading={false} />
