...
If you change the regular library drop chest to a trapped chest (making sure you keep the same location), any items placed into the chest by a copper golem will be sorted as well.

:::

:::warning[Lunge enchanted books]

If you grew a Library room before TARDIS v6.3.11, then chiseled book shelves for the three levels of Lunge enchanted books will be missing - you can add them to an existing library by using the command `/tardis update lunge`.
